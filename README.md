...
8. Взаимодействие с ОС.
 - Необходимо реализовать свой собственный UNIX-shell-утилиту с поддержкой команд: cd, pwd, echo, kill, ps.
9. Утилита wget.
...
## Чтение и понимание кода (listing)
~~~
Ответы на каждый вопрос даны в самих заданиях
~~~